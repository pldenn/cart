...
public class CartManagerTestNonEmptyWithSetup {
    ...
    private PurchaseItem first = new PurchaseItem(1, "first", 1, 1);
    private PurchaseItem second = new PurchaseItem(2, "second", 1, 1);
    private PurchaseItem third = new PurchaseItem(3, "third", 1, 1);
